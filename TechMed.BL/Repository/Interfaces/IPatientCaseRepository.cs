...
namespace TechMed.BL.Repository.Interfaces
{
    public interface IPatientCaseRepository : IRepository<PatientCase>
    {
        ...
        bool UploadCaseDocFromByte(List<CaseDocumentBase64VM> caseDocuments, string contentRootPath, out string file);
        ...
        Task<List<AllPendingPatient>> GetAllPendingPatient(DateTime? fromDate = null, DateTime? toDate = null);
        ...
        Task<bool> IsDoctorRoomBusy(long patientCaseID, string drEmail);
