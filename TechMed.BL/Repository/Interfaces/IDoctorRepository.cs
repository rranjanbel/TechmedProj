...
namespace TechMed.BL.Repository.Interfaces
{
    public interface IDoctorRepository : IRepository<DoctorMaster>
    {
        ...
        public Task<bool> UpdateDoctorDetails(DoctorDTO doctorDTO, string rootPath);
        ...
        public Task<DoctorMaster> AddDoctor(DoctorMaster doctorMaster, UserMaster userMaster, UserDetail userDetail,string BasePath);
